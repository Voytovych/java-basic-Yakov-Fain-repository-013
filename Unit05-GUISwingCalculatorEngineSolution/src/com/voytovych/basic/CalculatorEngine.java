...
/*
 * There is some adjustment addition to the original "Try it task".
 * 1. User input the first argument, display field shows the entered digits.
 * 2. User press "=" button, first argument entered, display field cleared.
 * 3. User input the second argument, display field shows the entered digits.
 * 4. User press operation button (+, -, /, ), the second argument entered,
 * display field shows the operation result.
 * 5. User press the "=" button, the last operation repeated (first argument is the display field value, second argument is the same as in step 4).
 * 
 * Note
 * the wrong press button order is ignored;
 * the wrong argument input in display field is ignored.
 * 
 */
